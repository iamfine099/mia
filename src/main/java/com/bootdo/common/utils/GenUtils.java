...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/common/generator/importExcel.html.vm");
        templates.add("templates/common/generator/importExcel.js.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        //非空列信息
        List<ColumnDO> notNullColumsList = new ArrayList<>();
        for (Map<String, String> column : columns) {
            ...
            //非空
            if ("NO".equalsIgnoreCase(column.get("isNullable")) && !"PRI".equalsIgnoreCase(column.get("columnKey"))) {
            	notNullColumsList.add(columnDO);
            }

            columsList.add(columnDO);
        }
        tableDO.setColumns(columsList);
        tableDO.setNotNullColumns(notNullColumsList);
        ...
        map.put("notNullColumns", tableDO.getNotNullColumns());
...
//		}
        ...
        if (template.contains("importExcel.html.vm")) {
        	 return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                     + packageName + File.separator + classname + File.separator + "importExcel.html";
        }
        if (template.contains("importExcel.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
                    + "appjs" + File.separator + packageName + File.separator + classname + File.separator + "importExcel.js";
        }
