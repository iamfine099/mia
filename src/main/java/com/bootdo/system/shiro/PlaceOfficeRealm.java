...
public class PlaceOfficeRealm extends AuthorizingRealm {
/*	@Autowired
	UserDao userMapper;
	@Autowired
...
//    }
     ...
     * 支持的登陆类型
     */
    private String supportedLoginType = "placeOffice";
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		map.put("fType",new String[] {Constant.USER_TYPE_PLACEMENT_OFFICE});
