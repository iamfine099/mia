$().ready(function() {
	...
	var achievement_intro = $("#achievementIntro").val();
	$('#achievementIntro_sn').summernote('code', achievement_intro);

    var application_category = $("#applicationCategory").val();
    $('#applicationCategory_sn').summernote('code', application_category);

    var prospect_analysis = $("#prospectAnalysis").val();
    $('#prospectAnalysis_sn').summernote('code', prospect_analysis);

    var detail_information = $("#detailInformation").val();
    $('#detailInformation_sn').summernote('code', detail_information);
...
function update() {
	...
	$.ajax({
		cache : true,
		type : "POST",
		url : "/common/article/updateAchievement",
		data: formData,
