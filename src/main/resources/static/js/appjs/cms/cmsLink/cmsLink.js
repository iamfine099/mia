					...
					//	showColumns : true,
						...
						columns : [
								...
								},	*/						
								{
									...
									title : '友情链接打开方式' ,
									formatter: function(value, row, index) {
										 return getDictLabelByValue(linkTargetList,value);  
									} 
								},
									...
									title : '链接与网站的关系',
									formatter: function(value, row, index) {
										 return getDictLabelByValue(linkRelList,value);  
									}  
								},							{
									field : 'fStatus', 
									title : '状态',
									formatter: function(value, row, index) {
										 return getDictLabelByValue(showHideList,value);  
									} 
								},
																{
									field : 'fListOrder', 
